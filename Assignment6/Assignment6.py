...
figure(3)                                                             # plotting the response x(t)
plot(t1,x4)
xlabel(r'$t$')
ylabel(r'$x(t)$')
plt.grid(True, color = "grey", linewidth = "1.4", linestyle = "-") 
title(r'x(t) - Question_4')
show()

figure(4)                                                             # plotting the response y(t)
plot(t1,y4)
xlabel(r'$t$')
ylabel(r'$y(t)$')
plt.grid(True, color = "grey", linewidth = "1.4", linestyle = "-") 
title(r'y(t) - Question_4')
show()
...
figure(5)                                                             # plotting the magnitude response on the semilogx plot
plt.semilogx(w,S)
xlabel(r'$w$')
ylabel(r'$|H(s)|$')
plt.grid(True, color = "grey", linewidth = "1.4", linestyle = "-") 
...
figure(6)                                                             # plotting the phase response on the semilogx plot
plt.semilogx(w,phi)
xlabel(r'$w$')
ylabel(r'Phase$(H(s))$')
plt.grid(True, color = "grey", linewidth = "1.4", linestyle = "-") 
...
figure(8)                                                             # plotting output and observing the steady state response 
plot(t3,vo1)
xlabel(r'$t$')
ylabel(r'V_output')
plt.grid(True, color = "grey", linewidth = "1.4", linestyle = "-") 
